...
describe("Performance Tests", () => {
  ...
  it("lazy loading is implemented for non-critical components", () => {
    ...
    expect(screen.getByRole("button", { name: /open dice roller/i })).toBeInTheDocument();
    ...
    expect(screen.getByRole("button", { name: /open table of contents/i })).toBeInTheDocument();
  ...
  it("text formatting is optimized", () => {
    ...
    const complexText = "**Bold** text with [link](https://example.com) and PLOT HOOK ".repeat(10);
