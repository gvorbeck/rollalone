...
const hexCrawler: CardProps = {
  ...
  postContent: [
    "**New Hex - Adjacent Terrain (2d6):**",
    "**2-3** - Current terrain +1 step*, **4-8** - Same as current terrain",
    "**9-11** - Current terrain +2 steps*, **12** - Roll HEX TERRAIN (random change)",
    "",
    "**Danger Level (d6):**",
    "**1** - Safe, **2-3** - Unsafe, **4-5** - Risky, **6** - Deadly",
    "",
    "**Points of Interest (d6, on 1):**",
    "**1-2** - Settlement, **3-4** - Structure, **5-6** - Natural landmark",
    "**7-8** - Monster lair, **9-10** - Tomb, **11** - Temple, **12** - Dungeon entrance",
    "",
    "**Travel Events (d6):**",
    "**1-4** - None, **5** - RANDOM EVENT then SET THE SCENE",
