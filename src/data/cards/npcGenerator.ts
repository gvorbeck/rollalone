...
const npcGenerator: CardProps = {
  ...
  postContent: [
    ...
    "**T** - Avenge, **J** - Fulfill Duty, **Q** - Escape",
    "**K** - Create, **A** - Serve",
    "",
    "**Notable Feature (d6):**",
    "**1** - Unremarkable, **2** - Notable nature",
    "**3** - Obvious physical trait, **4** - Quirk or mannerism",
    "**5** - Unusual equipment, **6** - Unexpected age or origin",
    "",
    "**Current Situation:**",
